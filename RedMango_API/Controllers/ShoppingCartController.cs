...
namespace RedMango_API.Controllers
{
    ...
    public class ShoppingCartController : ControllerBase
    {
        ...
        { 
            ...
            // updatequantityby wil have count by with an items quantity needs to be updated
            ...
            // when a user adds a new item to a a shopping cart for the first time
            // when a users adds a new item to an exisiting shopping cart (basically user has other items in cart)
            // when a user updates an existing item count
            // when a user removes an exiting item
